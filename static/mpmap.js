$(function() {
  ...
  var overlays = {
    ...
    "VFRMap.com Sectionals (US)" : new L.TileLayer('http://vfrmap.com/20190912/tiles/vfrc/{z}/{y}/{x}.jpg', {
                maxZoom : 12,
                minZoom : 3,
    ...
    "VFRMap.com - Low IFR (US)" : new L.TileLayer('http://vfrmap.com/20190912/tiles/ifrlc/{z}/{y}/{x}.jpg', {
                maxZoom : 12,
                minZoom : 5,
                attribution : '&copy; <a target="_blank" href="http://vfrmap.com">VFRMap.com</a>',
                tms : true,
